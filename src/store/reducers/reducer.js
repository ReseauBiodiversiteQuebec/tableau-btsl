...
let dmin=0.00001
let dmax=80
let legend_colors=colors.suitability
let legend_title='Convenance'

const initialState = {
  features: [],
  fetching: false,
  cog_uri: "https://object-arbutus.cloud.computecanada.ca/bq-io/io/btsl-connectivity/NC_NC-HabitatSuitability-BLBR-it22-ts2010.tif",
  current_layer: {},
  dmin: 0.001,
  dmax: 80,
